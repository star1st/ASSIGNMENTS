...
namespace restautrent_order_service
{
    public partial class od : Form
    {
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            f.Close();
            f.Open();
            SqlCommand md = new SqlCommand("select id from od", f);
        ...
        private void comboBox2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("Select *from od where id = '" + comboBox2.Text + "'", f);
            SqlDataReader dr = cmd.ExecuteReader();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
              SqlConnection f = new SqlConnection(constring);
            f.Open();
           SqlCommand cmd = new SqlCommand("insert into o (NAME,CNAME,PHONE,PRICE,QUANTITY,TOTAL,do) values(@A3,@A4,@A5,@A6,@A7,@A8,@A9)", f);
        ...
        //  cmd.Parameters.AddWithValue("@A8", textBox3.Text);
          ...
          cmd.Parameters.AddWithValue("@A9",textBox1.Text);
            cmd.ExecuteNonQuery();
            MessageBox.Show("DONE you get your order in 3o min");
            f.Close();
            this.Hide();
            Form2 f9 = new Form2();
            f9.Show();
